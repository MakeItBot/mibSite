...
export const pt: Translations = {
  ...
  blog: {
    ...
    heroSubtitle: "Insights, tutoriais e atualiza\u00e7\u00f5es da equipa Make It Bot. Mantenha-se informado sobre o \u00faltimo em desenvolvimento de software.",
    stayUpdated: "Fique Atualizado",
    stayUpdatedDesc: "Subscreva a nossa newsletter para os \u00faltimos artigos, tutoriais e insights da ind\u00fastria.",
  ...
  contact: {
    heroTitle: "Vamos ",
    heroTitleHighlight: "Conversar",
    heroSubtitle: "Pronto para come\u00e7ar o seu pr\u00f3ximo projeto? Entre em contacto e vamos discutir como podemos ajud\u00e1-lo a alcan\u00e7ar os seus objetivos.",
    ...
    withinHours: "Dentro de 24 horas",
    ...
    placeholders: {
      ...
      message: "Conte-nos sobre seu projeto, objetivos e qualquer requisito espec\u00edfico...",
    },
    sending: "Enviando...",
    sendMessage: "Enviar Mensagem",
    preferChat: "Prefere uma conversa r\u00e1pida?",
    preferChatDesc: "Agende uma chamada gratuita de 15 minutos para discutir seu projeto.",
    bookCall: "Agendar Chamada",
    faqTitle: "Perguntas Frequentes",
    faqSubtitle: "Respostas r\u00e1pidas para perguntas comuns",
    successTitle: "Mensagem enviada!",
    successDesc: "Voltaremos a contactar em 24 horas.",
